...
from theme import PANEL, SUBTLE, LINE, TEXT, DIM, FAINT, WARN_DARK
...
class ForceConfirmDialog:
    ...
    def __init__(self, parent, fonts, on_confirm):
        ...
        tk.Label(
            self.top,
            text="Tving en fuld synkronisering?",
            bg=PANEL,
            fg=TEXT,
        ...
        tk.Label(
            self.top,
            text=(
                "Alle AULA-mærkede Outlook-aftaler bliver gen-overført til "
        ...
        tk.Label(
            self.top,
            text=(
                "Brug det, hvis Aula-siden ser forkert ud, eller hvis du har "
