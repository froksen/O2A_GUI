...
class OpdaterView(tk.Frame):
    ...
    def _build(self):
        ...
        tk.Label(
            hdr, text="OPDATERING", bg=BG, fg=DIM, font=self._fonts["eyebrow"]
        ).pack(anchor="w")
        tk.Label(
            hdr, text="Opdatering", bg=BG, fg=TEXT, font=self._fonts["display_m"]
        ...
        # Technical info
        tk.Label(
            body, text="Teknisk information", bg=BG, fg=DIM, font=self._fonts["eyebrow"]
        ...
        for label, value in self._get_info_rows():
            ...
            tk.Label(row, text=value, bg=BG, fg=TEXT, font=self._fonts["body"]).pack(
                side="left"
            )
    ...
    def _confirm_update(self):
        ...
        tk.Label(
            dlg,
            text=(
                "Programmet lukker ned, henter den nyeste version fra GitHub, "
